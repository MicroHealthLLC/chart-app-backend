...
class DashboardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dashboard" do
    assert_difference('Dashboard.count') do
      post dashboards_url, params: { dashboard: { channel_id: @dashboard.channel_id, description: @dashboard.description, tags: @dashboard.tags, title: @dashboard.title } }, as: :json
    end
  ...
  test "should update dashboard" do
    patch dashboard_url(@dashboard), params: { dashboard: { channel_id: @dashboard.channel_id, description: @dashboard.description, tags: @dashboard.tags, title: @dashboard.title } }, as: :json
    assert_response 200
  end
